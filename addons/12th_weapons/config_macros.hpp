...
#define COMMON_RAIL_ATTACHMENTS {"OPTRE_BMR_Laser", "ACE_acc_pointer_red", "ace_acc_pointer_green", "ACE_acc_pointer_green_IR", "acc_pointer_ir", "OPTRE_M12_Laser","ACE_SPIR"}
